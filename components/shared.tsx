// Bilingual text. The CSS in globals.css shows one span and hides the other,
// driven by the `lang-en` class on <body> — same mechanism as the static build,
// so both languages are in the HTML for crawlers.
...
export const PHONE = '+995592105419'
export const PHONE_DISPLAY = '592 10 54 19'
export const EMAIL = 'qrebinfc@gmail.com'
export const WHATSAPP =
  'https://wa.me/995592105419?text=' +
  encodeURIComponent('გამარჯობა! Qrebi ბარათი მაინტერესებს')
